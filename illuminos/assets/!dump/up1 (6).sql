...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 21 2023 г., 16:18
...
INSERT INTO `products` (`product_id`, `name`, `price`, `country`, `year`, `model`, `category`, `time`, `count`, `path`, `video`, `opisanie`, `acters`, `rejiser`, `created_at`) VALUES
(3, 'Вызов', 6, 'Россия', 2023, 'Драма', 'Драма', '1ч 31мин', 7, 'assets/img/вызов.png', 'assets/video/вызов.mp4', 'Торакальный хирург Женя за месяц должна подготовиться к космическому полету и отправиться на МКС, чтобы спасти космонавта. Удастся ли ей справиться с испытаниями? Сможет ли она преодолеть неуверенность и страхи? Получится ли у нее провести сложнейшую операцию в условиях невесомости, от которой зависят шансы космонавта вернуться на Землю живым?', 'Юлия Пересильд\nМилош Бикович\nВладимир Машков\nОлег Новицкий\nАнтон Шкаплеров\nПётр Дубров\nЕлена Валюшкина\nВарвара Володина\nАндрей Щепочкин\nАлександр Балуев', ' Клим Шипенко', '2022-02-16 00:58:58'),
(5, 'Dark Web', 18, 'Россия', 2021, 'Ужастик', 'Ужастик', '', 8, 'assets/img/dark.png', '', '', '', '', '2022-02-16 00:58:58'),
(6, 'Плакса', 16, 'Россия', 2021, 'Драма', 'Драма', '', 9, 'assets/img/плакса.png', '', '', '', '', '2022-02-16 00:58:58'),
...
(11, 'Черное облако', 18, 'Россия', 2021, 'Ужастик', 'Ужастик', '', 8, 'assets/img/чо.png', '', '', '', '', '2022-02-16 00:58:58'),
